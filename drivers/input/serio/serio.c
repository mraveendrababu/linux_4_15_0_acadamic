...
static int serio_bind_driver(struct serio *serio, struct serio_driver *drv)
{
    ...
    printk (KERN_INFO "serio_bind_driver : Raveendra...  \n");
...
static void serio_find_driver(struct serio *serio)
{
    ...
    printk (KERN_INFO "serio_find_driver : Raveendra...  \n");
...
static struct serio_event *serio_get_event(void)
{
    ...
    printk (KERN_INFO "serio_event : Raveendra...  \n");
					  ...
					  enum serio_event_type type)
{
    ...
    printk (KERN_INFO "serio_remove_duplicate : Raveendra...  \n");
	spin_lock_irqsave(&serio_event_lock, flags);
...
static void serio_handle_event(struct work_struct *work)
{
    ...
    printk (KERN_INFO "serio_handle_event : Raveendra...  \n");
			     ...
			     enum serio_event_type event_type)
{
    ...
    printk (KERN_INFO "serio_queue_event : Raveendra...  \n");
	spin_lock_irqsave(&serio_event_lock, flags);
...
static void serio_remove_pending_events(void *object)
{
    ...
    printk (KERN_INFO "serio_remove_pending_events : Raveendra...  \n");
	spin_lock_irqsave(&serio_event_lock, flags);
...
static struct serio *serio_get_pending_child(struct serio *parent)
{
    ...
    printk (KERN_INFO "serio_serio_get_pending_child : Raveendra...  \n");
	spin_lock_irqsave(&serio_event_lock, flags);
...
static void serio_release_port(struct device *dev)
{
    ...
    printk (KERN_INFO "serio_release_port : Raveendra...  \n");
	kfree(serio);
...
static void serio_init_port(struct serio *serio)
{
    ...
    printk (KERN_INFO "serio_init_port : Raveendra...  \n");
...
static void serio_add_port(struct serio *serio)
{
    ...
    printk (KERN_INFO "serio_add_port : Raveendra...  \n");
	if (parent) {
...
static void serio_destroy_port(struct serio *serio)
{
    ...
    printk (KERN_INFO "serio_destroy_port : Raveendra...  \n");
...
static int serio_reconnect_port(struct serio *serio)
{
    ...
    printk (KERN_INFO "serio_reconnect_port : Raveendra...  \n");
	if (error) {
		serio_disconnect_port(serio);
		serio_find_driver(serio);
	}
...
static void serio_reconnect_subtree(struct serio *root)
{
    ...
    printk (KERN_INFO "serio_reconnect_subtree : Raveendra...  \n");
	do {
...
static void serio_disconnect_port(struct serio *serio)
{
    ...
    printk (KERN_INFO "serio_disconnect_port : Raveendra...  \n");
	/*
...
{
    printk (KERN_INFO "serio_register_port : Raveendra...  \n");
...
{
    printk (KERN_INFO "serio_unregister_port : Raveendra...  \n");
	mutex_lock(&serio_mutex);
	serio_disconnect_port(serio);
...
static ssize_t bind_mode_store(struct device_driver *drv, const char *buf, size_t count)
{
    ...
    printk (KERN_INFO "bind_mode_store : Raveendra...  \n");
	retval = count;
	if (!strncmp(buf, "manual", count)) {
...
static int serio_driver_probe(struct device *dev)
{
    ...
    printk (KERN_INFO "serio_driver_probe : Raveendra...  \n");
...
static int serio_driver_remove(struct device *dev)
{
    ...
    printk (KERN_INFO "serio_driver_remove : Raveendra...  \n");
	serio_disconnect_driver(serio);
	return 0;
}
...
{
    printk (KERN_INFO "serio_cleanup : Raveendra...  \n");
	mutex_lock(&serio->drv_mutex);
...
static void serio_shutdown(struct device *dev)
{
    ...
    printk (KERN_INFO "serio_shutdown : Raveendra...  \n");
	serio_cleanup(serio);
}
...
static void serio_attach_driver(struct serio_driver *drv)
{
    ...
    printk (KERN_INFO "serio_attach_driver : Raveendra...  \n");
...
int __serio_register_driver(struct serio_driver *drv, struct module *owner, const char *mod_name)
{
    ...
    printk (KERN_INFO "serio_register_driver : Raveendra...  \n");
...
void serio_unregister_driver(struct serio_driver *drv)
{
    ...
    printk (KERN_INFO "serio_unregister_driver : Raveendra...  \n");
	mutex_lock(&serio_mutex);
...
{
    printk (KERN_INFO "serio_set_drv : Raveendra...  \n");
...
static int serio_bus_match(struct device *dev, struct device_driver *drv)
{
    ...
    printk (KERN_INFO "serio_bus_match : Raveendra...  \n");
...
static int serio_uevent(struct device *dev, struct kobj_uevent_env *env)
{
    ...
    printk (KERN_INFO "serio_uevent : Raveendra...  \n");
...
static int serio_suspend(struct device *dev)
{
    ...
    printk (KERN_INFO "serio_suspend : Raveendra...  \n");
	serio_cleanup(serio);
...
static int serio_resume(struct device *dev)
{
    ...
    printk (KERN_INFO "serio_resume : Raveendra...  \n");
	mutex_lock(&serio->drv_mutex);
...
int serio_open(struct serio *serio, struct serio_driver *drv)
{
    ...
    printk (KERN_INFO "serio_open : Raveendra...  \n");
...
void serio_close(struct serio *serio)
{
    ...
    printk (KERN_INFO "serio_close : Raveendra...  \n");
	serio_set_drv(serio, NULL);
}
...
static int __init serio_init(void)
{
    ...
    printk (KERN_INFO "serio_init : Raveendra...  \n");
...
static void __exit serio_exit(void)
{
    ...
    printk (KERN_INFO "serio_exit : Raveendra...  \n");
	/*
