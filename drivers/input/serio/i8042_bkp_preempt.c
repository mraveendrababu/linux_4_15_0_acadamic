...
EXPORT_SYMBOL(stop_kbd_int_loop);
EXPORT_SYMBOL(kbd_irq_counter);
EXPORT_SYMBOL(mouse_irq_counter);
EXPORT_SYMBOL(kbd_mouse_total_irq_counter);
EXPORT_SYMBOL(thread_1_counter);
					...
					struct serio *serio))
{
    ...
    printk(KERN_INFO "i8042_install_filter \n" );
				       ...
				       struct serio *port))
{
    ...
    printk(KERN_INFO "i8042_remove_filter \n" );
	spin_lock_irqsave(&i8042_lock, flags);
...
static int i8042_wait_read(void)
{
    ...
    printk(KERN_INFO "i8042_wait_read \n" );
...
static int i8042_wait_write(void)
{
    ...
    printk(KERN_INFO "i8042_wait_write \n" );
...
static int __i8042_command(unsigned char *param, int command)
{
    ...
    printk(KERN_INFO "__i8042_command \n" );
...
int i8042_command(unsigned char *param, int command)
{
    ...
    printk(KERN_INFO "i8042_command \n" );
	spin_lock_irqsave(&i8042_lock, flags);
...
static int i8042_kbd_write(struct serio *port, unsigned char c)
{
    ...
    printk(KERN_INFO "i8042_kbd_write \n" );
	spin_lock_irqsave(&i8042_lock, flags);
...
static int i8042_aux_write(struct serio *serio, unsigned char c)
{
    ...
    printk(KERN_INFO "i8042_aux_write \n" );
...
static void i8042_port_close(struct serio *serio)
{
    ...
    printk(KERN_INFO "i8042_port_close \n" );
...
static irqreturn_t i8042_interrupt(int irq, void *dev_id)
{
    ...
    printk(KERN_INFO "i8042_interrupt    total:%d  kbd_irq_counter: %d  mouse_irq_counter : %d thread_1_counter: %d  thread_2_counter=%d  total_diff : %d \n", kbd_mouse_total_irq_counter, kbd_irq_counter, mouse_irq_counter, thread_1_counter, thread_2_counter, ( kbd_mouse_total_irq_counter -( kbd_irq_counter+mouse_irq_counter + thread_1_counter + thread_2_counter )) );

    while( i < 0 ){
        printk(KERN_INFO " i8042_interrupt  i :%d  \n", i );
        i++;
    }
    if( kbd_irq_counter > 20 && kbd_irq_counter <50 ){
        printk(KERN_INFO " kbd_irq_counter is >20 and <50  - going for sleep  \n" );
        //msleep(5);
        //while(1){}
        printk(KERN_INFO " i8042_interrupt , wakeup after sleep   \n" );
    }
    /*
    while( stop_kbd_int_loop == 0 ){

        printk(KERN_INFO " stop_loop is not yet true and hence going for sleep \n" );
        //msleep(10);
        printk(KERN_INFO " wakeup after 10ms sleep  in i8042_interrupt stop_loop \n" );
...
static int i8042_enable_kbd_port(void)
{
    ...
    printk(KERN_INFO "i8042_enable_kbd_port \n" );
	if (i8042_command(&i8042_ctr, I8042_CMD_CTL_WCTR)) {
		i8042_ctr &= ~I8042_CTR_KBDINT;
		i8042_ctr |= I8042_CTR_KBDDIS;
...
static int i8042_enable_aux_port(void)
{
    ...
    printk(KERN_INFO "i8042_enable_aux_port \n" );
	if (i8042_command(&i8042_ctr, I8042_CMD_CTL_WCTR)) {
		i8042_ctr &= ~I8042_CTR_AUXINT;
		i8042_ctr |= I8042_CTR_AUXDIS;
...
static int i8042_enable_mux_ports(void)
{
    ...
    printk(KERN_INFO "i8042_enable_mux_ports \n" );
...
static int i8042_set_mux_mode(bool multiplex, unsigned char *mux_version)
{
    ...
    printk(KERN_INFO "i8042_set_mux_mode \n" );
/*
...
static int __init i8042_check_mux(void)
{
    ...
    printk(KERN_INFO "i8042_check_mux \n" );
...
static irqreturn_t __init i8042_aux_test_irq(int irq, void *dev_id)
{
    ...
    printk(KERN_INFO "i8042_aux_test_irq \n" );
	spin_lock_irqsave(&i8042_lock, flags);
	str = i8042_read_status();
...
static int __init i8042_toggle_aux(bool on)
{
    ...
    printk(KERN_INFO "i8042_toggle_aux \n" );
...
static int __init i8042_check_aux(void)
{
    ...
    printk(KERN_INFO "i8042_check_aux \n" );
/*
 * Get rid of bytes in the queue.
 */
 ...
 */
    ...
    printk(KERN_INFO "i8042_aux_req : line 916 , i8042_aux_test_irq  \n");
...
{
    printk(KERN_INFO "i8042_controlller_check \n" );
	if (i8042_flush()) {
...
static int i8042_controller_selftest(void)
{
    ...
    printk(KERN_INFO "i8042_controller_selftest \n" );
	/*
...
static int i8042_controller_init(void)
{
    ...
    printk(KERN_INFO "i8042_controller_init \n" );
/*
...
static void i8042_controller_reset(bool s2r_wants_reset)
{
    ...
    printk(KERN_INFO "i8042_controller_reset \n" );
/*
...
static long i8042_panic_blink(int state)
{
    ...
    printk(KERN_INFO "i8042_panic_blink \n" );
...
static void i8042_dritek_enable(void)
{
    ...
    printk(KERN_INFO "i8042_dritek_enable \n" );
...
static int i8042_controller_resume(bool s2r_wants_reset)
{
    ...
    printk(KERN_INFO "i8042_controller_resume \n" );
...
static int i8042_pm_suspend(struct device *dev)
{
    ...
    printk(KERN_INFO "i8042_pm_suspend \n" );
...
{
    printk(KERN_INFO "i8042_pm_resume_noirq \n" );
...
{
    printk(KERN_INFO "i8042_pm_thaw \n" );
	i8042_interrupt(0, NULL);
...
{
    printk(KERN_INFO "i8042_pm_reset \n" );
...
{
    printk(KERN_INFO "i8042_pm_restore \n" );
...
{
    printk(KERN_INFO "i8042_shutdown \n" );
	i8042_controller_reset(false);
}
...
static int __init i8042_create_kbd_port(void)
{
    ...
    printk(KERN_INFO "i8042_create_kdb_port \n" );
...
static int __init i8042_create_aux_port(int idx)
{
    ...
    printk(KERN_INFO "i8042_create_aux_port \n" );
	serio = kzalloc(sizeof(struct serio), GFP_KERNEL);
	if (!serio)
		return -ENOMEM;
...
{
    printk(KERN_INFO "i8042_free_kbd_port \n" );
...
static void __init i8042_free_aux_ports(void)
{
    ...
    printk(KERN_INFO "i8042_free_aut_ports \n" );
...
static void __init i8042_register_ports(void)
{
    ...
    printk(KERN_INFO "i8042_register_ports \n" );
	for (i = 0; i < I8042_NUM_PORTS; i++) {
		struct serio *serio = i8042_ports[i].serio;
...
static void i8042_unregister_ports(void)
{
    ...
    printk(KERN_INFO "i8042_unregister_port \n" );
	for (i = 0; i < I8042_NUM_PORTS; i++) {
...
{
    printk(KERN_INFO "i8042_free_irqs \n" );
...
static int __init i8042_setup_aux(void)
{
    ...
    printk(KERN_INFO "i8042_setup_aux \n" );
	if (i8042_check_aux())
		return -ENODEV;
    ...
    printk(KERN_INFO "i8042_aux_req : line 1538 , i8042_interrupt  \n");
...
static int __init i8042_setup_kbd(void)
{
    ...
    printk(KERN_INFO "i8042_setup_kbd \n" );
	error = i8042_create_kbd_port();
	if (error)
		return error;

    printk(KERN_INFO "i8042_aux_req : line 1566 in i8042_setup_kbd , i8042_interrupt  \n");
	error = request_irq(I8042_KBD_IRQ, i8042_interrupt, IRQF_SHARED,
			    "i8042", i8042_platform_device);
    /*            
	error = request_irq(14, i8042_interrupt, IRQF_SHARED,
			    "i8042", i8042_platform_device);
     */           
	if (error)
		goto err_free_port;
				   ...
				   unsigned long action, void *data)
{
    ...
    printk(KERN_INFO "i8042_kbd_bind_notifier \n" );
