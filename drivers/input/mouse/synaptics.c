...
static int synaptics_mode_cmd(struct psmouse *psmouse, u8 mode)
{
    ...
    printk (KERN_INFO "synaptics_mode_cmd : Raveendra...  \n");
...
int synaptics_detect(struct psmouse *psmouse, bool set_properties)
{
    ...
    printk (KERN_INFO "synaptics_detect : Raveendra...  \n");
...
void synaptics_reset(struct psmouse *psmouse)
{
    ...
    printk (KERN_INFO "synaptics_reset : Raveendra...  \n");
...
static int synaptics_send_cmd(struct psmouse *psmouse, u8 cmd, u8 *param)
{
    ...
    printk (KERN_INFO "synaptics_send_cmd : Raveendra...  \n");
...
static int synaptics_query_int(struct psmouse *psmouse, u8 query_cmd, u32 *val)
{
    ...
    printk (KERN_INFO "synaptics_query_int : Raveendra...  \n");
			      ...
			      struct synaptics_device_info *info)
{
    ...
    printk (KERN_INFO "synaptics_idenitify : Raveendra...  \n");
...
static int synaptics_model_id(struct psmouse *psmouse,
			      struct synaptics_device_info *info)
{
    printk (KERN_INFO "synaptics_model_id : Raveendra...  \n");
...
static int synaptics_firmware_id(struct psmouse *psmouse,
				 struct synaptics_device_info *info)
{
    printk (KERN_INFO "synaptics_firmware_id : Raveendra...  \n");
				 ...
				 struct synaptics_device_info *info)
{
    ...
    printk (KERN_INFO "synaptics_query_modes : Raveendra...  \n");
				...
				struct synaptics_device_info *info)
{
    ...
    printk (KERN_INFO "synaptics_capability : Raveendra...  \n");
				...
				struct synaptics_device_info *info)
{
    ...
    printk (KERN_INFO "synaptics_resolution : Raveendra...  \n");
				    ...
				    struct synaptics_device_info *info)
{
    ...
    printk (KERN_INFO "synaptics_query_hardware : Raveendra...  \n");
				   ...
				   struct synaptics_device_info *info)
{
    ...
    printk (KERN_INFO "synaptics_apply_quirks : Raveendra...  \n");
...
{
    printk (KERN_INFO "synaptics_has_agm : Raveendra...  \n");
...
static int synaptics_pt_write(struct serio *serio, u8 c)
{
    ...
    printk (KERN_INFO "synaptics_pt_write : Raveendra...  \n");
...
static int synaptics_pt_start(struct serio *serio)
{
    ...
    printk (KERN_INFO "synaptics_pt_start : Raveendra...  \n");
...
static void synaptics_pt_stop(struct serio *serio)
{
    ...
    printk (KERN_INFO "synaptics_pt_stop : Raveendra...  \n");
	serio_pause_rx(parent->ps2dev.serio);
	priv->pt_port = NULL;
	serio_continue_rx(parent->ps2dev.serio);
}
...
static void synaptics_pass_pt_packet(struct serio *ptport, u8 *packet)
{
    ...
    printk (KERN_INFO "synaptics_pass_pt_packet : Raveendra...  \n");
...
static void synaptics_pt_activate(struct psmouse *psmouse)
{
    ...
    printk (KERN_INFO "synaptics_pt_activate : Raveendra...  \n");
...
static void synaptics_pt_create(struct psmouse *psmouse)
{
    ...
    printk (KERN_INFO "synaptics_pt_create : Raveendra...  \n");
				...
				struct synaptics_hw_state *hw)
{
    ...
    printk (KERN_INFO "synaptics_parse_agm : Raveendra...  \n");
					...
					struct synaptics_hw_state *hw)
{
    ...
    printk (KERN_INFO "synaptics_parse_ext_buttons : Raveendra...  \n");
				    ...
				    struct synaptics_hw_state *hw)
{
    ...
    printk (KERN_INFO "synaptics_parse_hw_state : Raveendra...  \n");
					  ...
					  bool active, int x, int y)
{
    ...
    printk (KERN_INFO "synaptics_report_semo_mt_slot : Raveendra...  \n");
	if (active) {
...
static void synaptics_report_semi_mt_data(struct input_dev *dev,
					  ...
					  int num_fingers)
{
    printk (KERN_INFO "synaptics_report_semi_mt_data : Raveendra...  \n");
	if (num_fingers >= 2) {
					 ...
					 const struct synaptics_hw_state *hw)
{
    ...
    printk (KERN_INFO "synaptics_ext_buttons : Raveendra...  \n");
				     ...
				     const struct synaptics_hw_state *hw)
{
    ...
    printk (KERN_INFO "synaptics_ : Raveendra...  \n");
				     ...
				     int num_fingers)
{
    ...
    printk (KERN_INFO "synaptics_report_mt_data : Raveendra...  \n");
					   ...
					   struct synaptics_hw_state *sgm)
{
    ...
    printk (KERN_INFO "synaptics_image_sensor_process : Raveendra...  \n");
	/*
...
static void synaptics_process_packet(struct psmouse *psmouse)
{
    ...
    printk (KERN_INFO "synaptics_process_packet : Raveendra...  \n");
				    ...
				    int idx, enum synaptics_pkt_type pkt_type)
{
    ...
    printk (KERN_INFO "synaptics_validate_byte : Raveendra...  \n");
	switch (pkt_type) {
...
synaptics_detect_pkt_type(struct psmouse *psmouse)
{
    ...
    printk (KERN_INFO "synaptics_pkt_type : Raveendra...  \n");
	for (i = 0; i < 5; i++) {
...
static psmouse_ret_t synaptics_process_byte(struct psmouse *psmouse)
{
    ...
    printk (KERN_INFO "synaptics_process_byte : Raveendra...  \n");
...
static void synaptics_disconnect(struct psmouse *psmouse)
{
    ...
    printk (KERN_INFO "synaptics_disconnect : Raveendra...  \n");
	/*
...
static int synaptics_reconnect(struct psmouse *psmouse)
{
    ...
    printk (KERN_INFO "synaptics_reconnect : Raveendra...  \n");
	do {
			      ...
			      bool absolute_mode)
{
    ...
    printk (KERN_INFO "synaptics_init_ps2 : Raveendra...  \n");
...
static int __synaptics_init(struct psmouse *psmouse, bool absolute_mode)
{
    ...
    printk (KERN_INFO "__synaptics_init : Raveendra...  \n");
	psmouse_reset(psmouse);
...
{
    printk (KERN_INFO "synaptics_init_absolute : Raveendra...  \n");
	return __synaptics_init(psmouse, true);
}

int synaptics_init_relative(struct psmouse *psmouse)
{
    printk (KERN_INFO "synaptics_init_relative : Raveendra...  \n");
			       ...
			       struct synaptics_device_info *info)
{
    ...
    printk (KERN_INFO "synaptics_setup_ps2 : Raveendra...  \n");
	/*
...
void __init synaptics_module_init(void)
{
    printk (KERN_INFO "synaptics_module_init : Raveendra...  \n");
}
				      ...
				      bool leave_breadcrumbs)
{
    ...
    printk (KERN_INFO "synaptics_setup_intertouch : Raveendra...  \n");
...
int synaptics_init_smbus(struct psmouse *psmouse)
{
    ...
    printk (KERN_INFO "synaptics_init_smbus : Raveendra...  \n");
	psmouse_reset(psmouse);
...
int synaptics_init(struct psmouse *psmouse)
{
    ...
    printk (KERN_INFO "synaptics_init : Raveendra...  \n");
	error = synaptics_query_hardware(psmouse, &info);
	if (error) {
		psmouse_err(psmouse, "Unable to query device: %d\n", error);
		return error;
